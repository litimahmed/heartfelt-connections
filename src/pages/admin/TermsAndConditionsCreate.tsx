...
import { TermsAndConditionsFormData, ContentSection } from "@/types/admin/termsAndConditions";
import { ArrowLeft, Save, X, FileText, Settings, ListOrdered } from "lucide-react";
...
function TermsAndConditionsForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    createTermsAndConditions(apiData as any, {
      onSuccess: () => {
              ...
              <Card className="border-border/50">
                <CardContent className="p-6 space-y-6">
                  ...
                  <MultilingualField
                    ...
                    rows={4}
                    placeholder={{
                      ar: "مقدمة عن شروط الاستخدام...",
                      fr: "Introduction aux conditions d'utilisation...",
                      en: "Introduction to the terms of service...",
                    }}
                  />
                </CardContent>
              </Card>
              ...
              <Card className="border-border/50 bg-muted/30">
                <CardContent className="p-6">
                  ...
                  <ul className="text-xs text-muted-foreground space-y-2">
                    ...
                    <li>• Une seule condition active à la fois</li>
                  </ul>
                </CardContent>
              </Card>
            </div>
