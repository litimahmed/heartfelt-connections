...
const formSchema = z.object({
    ...
    telephone: z.string()
        .min(13, "Le téléphone doit contenir 13 caractères (ex: +213781913776)")
        .max(13, "Le téléphone doit contenir 13 caractères (ex: +213781913776)")
        .regex(phoneRegex, "Format invalide. Utilisez le format: +213XXXXXXXXX"),
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <p className="text-xs text-muted-foreground mt-1">
                                            Format: +213XXXXXXXXX (13 caractères)
                                        </p>
                                        <FormMessage />
                                    </FormItem>
                                )}
